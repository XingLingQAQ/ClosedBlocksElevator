...
public enum ElevatorMessage implements MessageDeclaration {
    ...
    RENAME_FAILED("RenameFailed", "&dFailed to rename elevator to&7 {name}"),
    RENAME_ALREADY("RenameExisting", "&dFailed to rename elevator to&7 {name}&d. There's another elevator with that name"),
    RENAME_SUCCESS("RenameSuccess", "&3Successfully renamed elevator to&7 {name}"),
